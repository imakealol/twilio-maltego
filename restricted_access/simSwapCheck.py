...
def sim_swap_phone_lookup(account_sid: str, auth_token: str, phone_number: str):
    client = Client(account_sid, auth_token)
    response = client.lookups.v2.phone_numbers(phone_number).fetch(fields='sim_swap')
...
class simSwapCheck(DiscoverableTransform):
    ...
    def create_entities(cls, request: MaltegoMsg, response: MaltegoTransform):
        ...
        async def main():
            ...
            lookup = sim_swap_phone_lookup(account_sid, auth_token, phone_number)
